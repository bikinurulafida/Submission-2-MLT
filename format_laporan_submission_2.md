...
## Visualisasi Data
Untuk mendapatkan pemahaman yang lebih baik mengenai distribusi dan karakteristik data, dilakukan beberapa visualisasi menggunakan teknik eksplorasi data:
- Distribusi Rating Buku: Dengan histogram dan boxplot, kita bisa melihat distribusi rating buku. Banyak buku memiliki rating yang cenderung rendah atau sangat tinggi.
- Distribusi Jumlah Halaman: Dengan histogram, kita bisa melihat bahwa sebagian besar buku memiliki jumlah halaman yang relatif moderat, dengan beberapa buku yang sangat panjang.
- Distribusi Jumlah Rating dan Ulasan: Distribusi ini menunjukkan bahwa sebagian besar buku memiliki sedikit ulasan dan rating, sementara beberapa buku sangat populer dan mendapat banyak perhatian.
- Distribusi Bahasa Buku: Dengan visualisasi countplot, kita bisa melihat berapa banyak buku yang ada dalam setiap bahasa.
- Top 10 Penulis Terbanyak: Melalui barplot, kita dapat melihat siapa saja penulis yang memiliki jumlah buku terbanyak di platform Goodreads.
